...
export default function Dashboard({ auth, opdlist, existing_opd_tickets, msg, msgtype }) {
        ...
        >
            ...
            <div className='container py-12'>
                ...
                <div className='row'>
                            ...
                            <div className="card-body">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {existing_opd_tickets.data.map((d) => (
                    ...
                    <div className='col-6'>
                        <div className="card mb-3">
                            <div className='card-header'><b>Your Pending ABTC to iClinicSys Tickets</b></div>
                            <div className="card-body">
                                <div
                                    className="table-responsive"
                                >
                ...
                <div className='row'>
                    ...
                    <div className='col-6'>
                        <div className="card border-success">
                            <div className='card-header bg-success text-white'>Animal Bite to iClinicSys</div>
                            <div className="card-body">
