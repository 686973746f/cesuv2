...
export default function Dashboard({ auth, list }: PageProps) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">OPD to iClinicSys Ticketing</h2>}
        >
                                            ...
                                            <tr className="whitespace-nowrap">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="text-sm text-gray-900">
                                                        Jon doeasdasdasdasdasdasdasdasdasdasdasdasd
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
